...
class X_RAY_Scan(models.Model):
    ...
    def action_walk_in_patient(self):
        return {
            ...
            'res_model': 'scanning.x.ray',
            'view_mode': 'tree,form',
            'views': [(self.env.ref('homeo_doctor.view_xray_walk_in_tree').id, 'tree'),
                      (self.env.ref('homeo_doctor.view_scanning_x_ray_form').id, 'form')],
    ...
    def create(self, vals):
        ...
        return super(X_RAY_Scan, self).create(vals)
